...
const disciplines = ['MentorShip', 'Problem Solving']; //Home first  Changing Animation
  ...
  return (
    <div className="home">
      ...
      <ProjectSummary
        ...
        description="Design and development for Android Apps"
        buttonText="View Course Catelogue"
        buttonLink="https://google.com" //Todo change the link address
        model={{
          type: 'phone',
